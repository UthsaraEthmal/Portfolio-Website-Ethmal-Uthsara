        ...
        <div className="footer-container">
          ...
          <div className="footer-section1">
            ...
            <ul>
              <li>
                <Link to="/">
                  <IoIosArrowForward className="footer-arrow" /> Home
                </Link>
              </li>
              <li>
                <Link to="/About">
                  <IoIosArrowForward className="footer-arrow" /> About me
                </Link>
              </li>
              <li>
                <Link to="/Service">
                  <IoIosArrowForward className="footer-arrow" /> Service
                </Link>
              </li>
              <li>
                <Link to="/Projects">
                  <IoIosArrowForward className="footer-arrow" /> Projects
                </Link>
              </li>
              <li>
                <Link to="/Contact">
                  <IoIosArrowForward className="footer-arrow" /> Contact me
                </Link>
              </li>
            </ul>
          </div>
