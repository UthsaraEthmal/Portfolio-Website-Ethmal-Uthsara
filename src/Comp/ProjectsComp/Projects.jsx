          ...
          <Slider {...settings}>
            <motion.div className="cardp" variants={item}>
              ...
              <p>
                ...
                line by taking inputs of exams, then computes the final grade
                based on the specified criteria. Two separate paths for students
                and for the academic staff
              </p>
            ...
            <motion.div className="cardp" variants={item}>
              ...
              <p>
                ...
                facilitating easy booking (including file handling, and
                exception handling).
              </p>
              <a
            ...
            <motion.div className="cardp" variants={item}>
              ...
              <p>
                ...
                utilizes "object-oriented programming principles" and Java Swing
                for the user interface. It offers two separate versions for
                staff and customers.
              </p>
            ...
            <motion.div className="cardp" variants={item}>
              ...
              <p>
                ...
                and JavaScript, offering interactive content and resources
                focused on snake conservation and ecology, along with an
                educational quiz
              </p>
            ...
            <motion.div className="cardp" variants={item}>
              ...
              <p>
                ...
                starting and ending points, utilizing the Dijkstra algorithm.
            ...
            <motion.div className="cardp" variants={item}>
              ...
              <p>
                ...
                React.js, HTML, CSS, and JavaScript. It features responsive
                design, interactive content, smooth animations, and downloadable
                resources.
              </p>
